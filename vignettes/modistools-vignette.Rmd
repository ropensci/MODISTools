...
Below an example is provided on how to download a MODIS time series as well as list ancillary data.
...
Once you decide on which data to download using the above functions you can use these parameters to download a time series using the get_subset() function.
...
In both download functions data can be written to a csv file in a particular directory. The read_subset() function allows you to read in the data easily and into the same data structure as used when downloading directy into your R workspace.
